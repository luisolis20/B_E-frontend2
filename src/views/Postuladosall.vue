<template>
    <div class="container-fluid py-5">
        ...
        <br><br>
        <div class="d-flex justify-content-center mb-4" >
            <button class="btn btn-primary text-white" @click="mostrargraficoM" v-if="!mostrargrafico">Mostrar Gráfico Estadístico</button>
            &nbsp;&nbsp;&nbsp;
            <button class="btn btn-primary text-white" v-if="mostrargrafico" @click="ocultargraficoM">Ocultar Gráfico Estadístico</button>
        </div>
        <div class="container mt-5" v-if="mostrargrafico">
    ...
    methods: {
        ...
        generarGrafico() {
            ...
            this.postulacionespr.forEach(post => {
                const clave = `${post.Oferta} - ${post.estado}`;
                if (!conteo[clave]) {
                    conteo[clave] = 0;
                }
                conteo[clave]++;
