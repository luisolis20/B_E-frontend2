...
<script>
    ...
    export default{
        data(){
            return{
                idus:0,
                url213:'http://192.168.1.15/b_e/api/vin/consultapostuser',
                postulaciones:null,
                cargando:false
            }
        },
        ...
        methods:{
            ...
            eliminar(id,nombre){
                confimar('http://192.168.1.15/b_e/api/vin/consultapostuser/',id,'Eliminar registro','¿Realmente desea eliminar a '+nombre+'?');
                this.getPostulaciones();
                this.cargando = false;
