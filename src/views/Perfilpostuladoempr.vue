        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                    ...
                    <img v-if="fotografia" :src="'data:image/jpeg;base64,' + fotografia" id="fotoimg" width="500" height="500" style="border-radius: 10px;" alt="">
                    <img v-else
                ...
                <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row g-4 text-dark mb-5">
                        ...
                        <div class="col-sm-12">
                            <i class="fas fa-share text-primary me-2"></i><b>Nombres y apellidos: </b> {{ NombInfPer }} {{ ApellInfPer
                            }}{{ ApellMatInfPer }} 
                        </div>
                        <div class="col-sm-12">
...
export default {
    ...
    methods: {
        ...
        aceptarpost2() {
            ...
            enviarsoliedit('PUT', parametros,this.urlest, 'Postulación Aceptada');
        ...
        rechazarpost2() {
            ...
            enviarsoliedit('PUT', parametros,this.urlest, 'Postulación Rechazada');
            this.$router.push('/principal/' + this.id);
