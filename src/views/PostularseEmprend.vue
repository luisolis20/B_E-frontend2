    ...
    <div class="container-fluid RSVP-form py-3" id="weddingRsvp">
        <div class="container py-3">
            <div class="mb-5 text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width: 800px;">
                ...
                <p class="text-dark">Revisa los detalles de la oferta y postúlate si cumples con los requisitos. Esta es una oferta de un emprendimiento de un estudiante graduado/a de la UTLVTE</p>
            </div>
        ...
        getEmpresa(){
           axios.get(this.urk32).then(
                res=>{
                    ...
                    this.jefe=res.data.data[0].ApellInfPer;
                }
            );
        },
        async guardar(event) {
