...
<script>
    ...
    export default{
        data(){
            return{
                idus:0,
                url213:'http://vinculacionconlasociedad.utelvt.edu.ec/backendbolsaempleo/api/b_e/vin/consultapostuserestado',
                postulacionespr: [],
        ...
        methods:{
            ...
            eliminar(id,nombre){
                confimar('http://vinculacionconlasociedad.utelvt.edu.ec/backendbolsaempleo/api/b_e/vin/consultapostuserestado/',id,'Eliminar registro','¿Realmente desea eliminar a '+nombre+'?');
                this.cargando = false;
