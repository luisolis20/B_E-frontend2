                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="section-heading">
                        <h4 class="text-primary display-6 fw-bold mb-0">Registre <strong class="text-secondary"> su </strong> Empresa</h4>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <button type="submit" v-on:click="guardar" id="form-submit" class="orange-button">Guardar Datos</button>
                      </fieldset>
                    </div>
                  </div>
                </form>
