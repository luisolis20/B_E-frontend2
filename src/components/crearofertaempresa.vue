    ...
    <div class="container-fluid RSVP-form py-3" id="weddingRsvp">
        <div class="container py-3">
            <div class="mb-5 text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width: 800px;">
                ...
                <p class="text-dark" v-if="mostrarOpciones">En este apartado visualizarás los datos de tu empresa, no
                    podrás editarlo. Aquí lo que harás es crear una oferta laboral para tu empresa</p>
                <h1 class="display-2 text-primary" v-if="mostrarOpciones3">Datos de la Empresa</h1>
                <p class="text-dark" v-if="mostrarOpciones3">Aquí podrás ver la información a detalle de la empresa</p>
            </div>
                    ...
                    <div class="p-5 border-secondary position-relative" style="border-style: double;">
                        ...
                        <form>
                            <div class="testimonial-inner-img">
                                <img v-if="previewFoto" :src="previewFoto" class="img-fluid rounded-circle" alt="Image">
                            ...
                            <div class="row gx-4 gy-3">
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="ruce" class="form-control py-3 border-0 text-dark"
                                ...
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="nombree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">Ciudad</label>
                                        <input type="text" v-model="ciudade"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">País</label>
                                        <input type="text" v-model="paise" class="form-control py-3 border-0 text-dark"
                                            id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="tipo_empresae"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="telefonoe"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="emailempree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="urlempree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">Título del Representante
                                            de la Empresa</label>
                                        <input type="text" v-model="titulorepree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">Nombre del Representante
                                            de la Empresa</label>
                                        <input type="text" v-model="nombrerepree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">Cargo del Representante de
                                            la Empresa</label>
                                        <input type="text" v-model="cargorepree"
                                            class="form-control py-3 border-0 text-dark" id="Examplename" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <textarea name="text" v-model="direccione"
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="exampletextarea" class="form-label text-dark">Misión</label>
                                        <textarea name="text" v-model="misione" class="form-control border-0 text-dark"
                                            id="exampletextarea" cols="30" rows="5" disabled></textarea>
                                    </div>
                                </div>
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="exampletextarea" class="form-label text-dark">Visión</label>
                                        <textarea name="text" v-model="visione" class="form-control border-0 text-dark"
                                            id="exampletextarea" cols="30" rows="5" disabled></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-center border border-secondary p-4 my-4 position-relative"
                                        ...
                                        <div class="mt-4">
                                            <div class="col-12 text-center wow fadeIn" data-wow-delay="0.1s">
                                                <router-link :to="{ path: '/ofertanew/' + ide }"
                                                    class="btn btn-primary btn-primary-outline-0 py-3 px-5 text-white">Clic
                                                    Aquí</router-link>
                                            </div>
                                        </div>
                                    </div>
        ...
        getEmpresa() {
            API.get(this.urk3).then(
                res => {
                    ...
                    this.fotografia = res.data.data.imagen;
                    this.previewFoto = 'data:image/jpeg;base64,' + res.data.data.imagen;
