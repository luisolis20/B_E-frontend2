...
export default {
  data() {
    return {
      ...
      accessToken: 'EAAUbvwr8S4UBPxVkXsj9KuYAyxhuzWZCtBb29bX8lmRdgtbaiqDZBskNZA2c5ryH10uq0jZCbJhRWV0SCBvDagSrdZABIDX0xf0fIChvORIpQq9CyHFfsjW8WcxtEKi6bTZA48ZBRb1bTvUZBvRoUuNsSn2Fsog6RjzZBydmsZC7SyzWuz2ZCd2JilgC0xyvjVc0aPhLP39',
    }
  },
  async mounted() {
    //const ruta = useRoute();
